...
This is a blog that's probably going to be short enough to be a small series of Tweets. But I don't have X/Twitter. Nor is this important enough to broadcast in a X/Twitter kind of way (not that many X/Twitter users set that boundary for themselves). But somehow it seems most people aren't doing this yet.
